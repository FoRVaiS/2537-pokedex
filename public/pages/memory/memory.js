(async () => {
  ...
  const generateBtn = document.querySelector('#in-generate');
  
  generateBtn.onclick = e => {
    e.preventDefault();
    
    const widthField = getRequiredValueFrom('input[name=\'width\']', Number);
    const heightField = getRequiredValueFrom('input[name=\'height\']', Number);

    createGame(widthField, heightField);
  };
